...
<body>
  <div class="container">
    <section>
      ...
      <form method="post" action="form.php?q=6" enctype="multipart/form-data">
      ...
      <div class="pager">
        ...
        <a style="background-color: black; color: white;" href="index.php?q=<?php echo $taskNumber = 6; ?>">Question 6</a>
